                    ...
                    <div class="left-icons">
                        ...
                        <div class="right-icons">
                            <?php if(pg_affected_rows(pg_query($con, "SELECT * FROM posting_disimpan WHERE id_postingan = $id_postingan AND email_penyimpan = '$email'")) === 0){ ?>
                                <a href="./save_post.php?id=<?= $id_postingan; ?>&email_penyimpan=<?= $email; ?>&jalur=new_post"><img src="images/save.png" alt="Save Icon" class="footer-icon"></a>
                            <?php }else{ ?>
                                <a href="./delete_saved.php?id=<?= $id_postingan; ?>&email_penyimpan=<?= $email; ?>&jalur=new_post"><img src="images/bookmark.png" alt="Saved Icon" class="footer-icon"></a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
